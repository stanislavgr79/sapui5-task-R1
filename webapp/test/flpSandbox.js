		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dummyfirstapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dummyfirstapp-display": {
								"semanticObject": "dummyfirstapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dummy.firstapp",
									"url": sap.ui.require.toUrl("dummy/firstapp")
								}
							}
						}
					}
